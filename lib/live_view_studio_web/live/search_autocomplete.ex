defmodule LiveViewStudioWeb.SearchAutoCompleteLive do
  ...
  def render(assigns) do
    ...
    <div id="search">
      ...
      <form phx-submit="city-search" phx-change="city-suggestion">
      <input list="matches" type="text" name="city" value="<%= @city %>"
             placeholder="City"
             autocomplete="off"
             phx-debounce="1000"
             <%= if @loading, do: "readonly" %> />
  ...
  def handle_event("city-suggestion", %{"city" => city}, socket) do
    socket =
      assign(socket,
        city: city,
