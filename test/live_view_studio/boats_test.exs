defmodule LiveViewStudio.BoatsTest do
  ...
  describe "boats" do
    ...
    @valid_attrs %{image: "some image", model: "some model", price: "some price"}
    @update_attrs %{image: "some updated image", model: "some updated model", price: "some updated price"}
    @invalid_attrs %{image: nil, model: nil, price: nil}
